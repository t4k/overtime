...
springSpace.public = {}, springSpace.public._construct = function() {
    ...
    e.prototype.loadHomepageList = function(e) {
        ...
        s && (r += " Found", mobileLabel = e.count + " Matching Result" + (1 == e.count ? "" : "s") + " for:"), jQuery("#s-lg-az-result-count").html('<span class="d-sm-none" aria-hidden="true">' + mobileLabel + '</span><span class="d-none d-md-block">' + r + "</span>"), Object.keys(e.subjects ?? []).forEach((function(s) {
            jQuery("#s-lg-az-result-count").after("<span class='az-mobile-filter d-sm-none' aria-hidden='true'>" + e.subjects[s] + "<a onclick='springSpace.publicObj.filterAzBySubjectEdit(" + s + ", " + t + "); return false;'><img src='/web/assets/media/icons/duotune/arrows/arr097.svg' role='presentation'/></a></span>")
        })), Object.keys(e.types ?? []).forEach((function(s) {
            jQuery("#s-lg-az-result-count").after("<span class='az-mobile-filter d-sm-none' aria-hidden='true'>" + e.types[s] + "<a onclick='springSpace.publicObj.filterAzByTypeEdit(" + s + ", " + t + "); return false;'><img src='/web/assets/media/icons/duotune/arrows/arr097.svg' role='presentation'/></a></span>")
        })), Object.keys(e.vendors ?? []).forEach((function(s) {
            jQuery("#s-lg-az-result-count").after("<span class='az-mobile-filter d-sm-none' aria-hidden='true'>" + e.vendors[s] + "<a onclick='springSpace.publicObj.filterAzByVendorEdit(" + s + ", " + t + "); return false;'><img src='/web/assets/media/icons/duotune/arrows/arr097.svg' role='presentation'/></a></span>")
        })), e.q && jQuery("#s-lg-az-result-count").after("<span class='az-mobile-filter d-sm-none' aria-hidden='true'>" + e.q + "<a onclick='springSpace.publicObj.filterAzBySearchEdit(" + t + "); return false;'><img src='/web/assets/media/icons/duotune/arrows/arr097.svg' role='presentation'/></a></span>"), s && jQuery(".az-mobile-filter:last-of-type").after("<a id='az-mobile-filter-edit' aria-hidden='true' class='d-sm-none' data-bs-toggle='modal' data-bs-target='#az-mobile-filter-edit-modal'><i class='fa fa-pencil' aria-hidden='true'></i>&nbsp;Edit Filters</a>")
